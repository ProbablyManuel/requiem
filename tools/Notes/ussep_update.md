...
You can use [find_ussep_papyrus_script_diff.py](../Python/find_ussep_papyrus_script_diff.py) to identify scripts used by Requiem that have been changed between the old and new USSEP version.
