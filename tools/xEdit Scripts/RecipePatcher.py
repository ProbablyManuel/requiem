...
weapon_materials = pd.read_excel("../Spreadsheet/Weapon.xlsx", sheet_name="Weapons", index_col=0, usecols=["Unnamed: 0", "Primary", "Secondary", "Temper", "Perk"]).convert_dtypes().dropna(how="all")
...
weapon_artifacts = pd.read_excel("../Spreadsheet/Weapon.xlsx", sheet_name="Artifacts", index_col=0, usecols=["Unnamed: 0", "Base", "Divine"]).convert_dtypes().dropna()
...
armor_materials = pd.read_excel("../Spreadsheet/Armor.xlsx", sheet_name="Armors", index_col=0, usecols=["Unnamed: 0", "Primary", "Secondary", "Leather", "Temper", "Perk"]).convert_dtypes().dropna(how="all")
...
armor_artifacts = pd.read_excel("../Spreadsheet/Armor.xlsx", sheet_name="Artifacts", index_col=0, usecols=["Unnamed: 0", "Base", "Divine"]).convert_dtypes().dropna()
