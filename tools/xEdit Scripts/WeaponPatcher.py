...
weapon = pd.read_excel("../Spreadsheet/Weapon.xlsx", sheet_name="Weapons", index_col=0, usecols=[0, 1, 2, 3]).convert_dtypes()
weapon_types = pd.read_excel("../Spreadsheet/Weapon.xlsx", sheet_name="Stats", index_col=0).convert_dtypes().dropna()
weapon_artifacts = pd.read_excel("../Spreadsheet/Weapon.xlsx", sheet_name="Artifacts", index_col=0).convert_dtypes().dropna(how="all")
