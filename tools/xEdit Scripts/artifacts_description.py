...
ignore = [
    ...
    "REQ_Cloth_Cultist_Body",
    "REQ_Cloth_Dremora_Body",
    "REQ_Cloth_Dremora_Feet",
    "REQ_Cloth_Dunmer_Body_Blue",
    "REQ_Cloth_Dunmer_Body_BlueHooded",
    "REQ_Cloth_Dunmer_Body_Red",
    "REQ_Cloth_Dunmer_Body_RedHooded",
    "REQ_Cloth_Dunmer_Body_Yellow",
    "REQ_Cloth_Dunmer_Body_YellowHooded",
    "REQ_Cloth_Necromancer_Body",
    "REQ_Cloth_Necromancer_Body_Hooded",
    "REQ_Cloth_TemplePriest_Body",
    ...
    "REQ_Var_Light_ThievesGuild_Body_Improved",
    "REQ_Var_Light_ThievesGuild_Feet_Improved",
    "REQ_Var_Light_ThievesGuild_Hands_Improved",
    "REQ_Var_Light_ThievesGuild_Head_Improved",
    "REQ_Var_Ring_Gold_Frida",
    "REQ_Var_Ring_Gold_Marriage",
    "REQ_Var_Ring_Gold_Saarthal",
    "REQ_Var_Ring_Silver_Muiri",
