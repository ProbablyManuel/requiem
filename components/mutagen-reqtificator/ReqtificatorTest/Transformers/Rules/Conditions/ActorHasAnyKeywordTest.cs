...
{
    public class ActorHasAnyKeywordTest
    {
        ...
        [Fact]
        public void Should_match_an_actor_with_a_single_inheritance_and_a_matching_keyword_defined_on_the_actor()
        {
            ...
            var condition = new ActorHasAnyKeyword(new HashSet<IFormLinkGetter<IKeywordGetter>>
                {Keyword1, Keyword2}.ToImmutableHashSet(), graph.Object);
            condition.CheckRecord(actor).Should().BeTrue();
        }

        [Fact]
        public void Should_match_an_actor_with_a_single_inheritance_and_a_matching_keyword_defined_on_the_race()
        {
            var graph = new Mock<IActorInheritanceGraphParser>(MockBehavior.Strict);
            var cache = new Mock<ILinkCache<ISkyrimMod, ISkyrimModGetter>>(MockBehavior.Strict);
            IRaceGetter race = new Race(FormKey.Factory("ABCDEF:Requiem.esp"), SkyrimRelease.SkyrimSE)
        ...
        [Fact]
        public void Should_match_an_actor_with_multiple_inheritances_all_having_at_least_one_of_the_required_keywords()
        {
            var graph = new Mock<IActorInheritanceGraphParser>(MockBehavior.Strict);
            var cache = new Mock<ILinkCache<ISkyrimMod, ISkyrimModGetter>>(MockBehavior.Strict);
            IRaceGetter race = new Race(FormKey.Factory("ABCDEF:Requiem.esp"), SkyrimRelease.SkyrimSE)
        ...
        [Fact]
        public void Should_not_match_an_actor_with_a_single_inheritance_and_no_matching_keyword()
        {
            var graph = new Mock<IActorInheritanceGraphParser>(MockBehavior.Strict);
            var cache = new Mock<ILinkCache<ISkyrimMod, ISkyrimModGetter>>(MockBehavior.Strict);
            IRaceGetter race = new Race(FormKey.Factory("ABCDEF:Requiem.esp"), SkyrimRelease.SkyrimSE)
        ...
        [Fact]
        public void Should_not_match_an_actor_with_multiple_inheritances_if_any_of_them_has_no_matching_keyword()
        {
            var graph = new Mock<IActorInheritanceGraphParser>(MockBehavior.Strict);
            var cache = new Mock<ILinkCache<ISkyrimMod, ISkyrimModGetter>>(MockBehavior.Strict);
            IRaceGetter race = new Race(FormKey.Factory("ABCDEF:Requiem.esp"), SkyrimRelease.SkyrimSE)
