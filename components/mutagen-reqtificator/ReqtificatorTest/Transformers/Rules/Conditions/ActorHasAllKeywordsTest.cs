...
{
    public class ActorHasAllKeywordsTest
    {
        ...
        [Fact]
        public void Should_match_an_actor_with_a_single_inheritance_and_the_keywords_split_among_actor_and_race()
        {
        ...
        [Fact]
        public void Should_match_an_actor_with_a_single_inheritance_and_all_keywords_defined_on_the_actor()
        {
            var graph = new Mock<IActorInheritanceGraphParser>(MockBehavior.Strict);
            var cache = new Mock<ILinkCache<ISkyrimMod, ISkyrimModGetter>>(MockBehavior.Strict);
            IRaceGetter? race = new Race(FormKey.Factory("ABCDEF:Requiem.esp"), SkyrimRelease.SkyrimSE)
        ...
        [Fact]
        public void Should_match_an_actor_with_a_single_inheritance_and_all_keywords_defined_on_the_race()
        {
            var graph = new Mock<IActorInheritanceGraphParser>(MockBehavior.Strict);
            var cache = new Mock<ILinkCache<ISkyrimMod, ISkyrimModGetter>>(MockBehavior.Strict);
            IRaceGetter? race = new Race(FormKey.Factory("ABCDEF:Requiem.esp"), SkyrimRelease.SkyrimSE)
        ...
        [Fact]
        public void Should_match_an_actor_with_multiple_inheritances_all_having_the_required_keywords()
        {
            var graph = new Mock<IActorInheritanceGraphParser>(MockBehavior.Strict);
            var cache = new Mock<ILinkCache<ISkyrimMod, ISkyrimModGetter>>(MockBehavior.Strict);
            IRaceGetter? race = new Race(FormKey.Factory("ABCDEF:Requiem.esp"), SkyrimRelease.SkyrimSE)
        ...
        [Fact]
        public void Should_not_match_an_actor_with_a_single_inheritance_and_at_least_one_missing_keyword()
        {
            var graph = new Mock<IActorInheritanceGraphParser>(MockBehavior.Strict);
            var cache = new Mock<ILinkCache<ISkyrimMod, ISkyrimModGetter>>(MockBehavior.Strict);
            IRaceGetter? race = new Race(FormKey.Factory("ABCDEF:Requiem.esp"), SkyrimRelease.SkyrimSE)
        ...
        [Fact]
        public void Should_not_match_an_actor_with_multiple_inheritances_if_any_of_them_misses_keywords()
        {
            var graph = new Mock<IActorInheritanceGraphParser>(MockBehavior.Strict);
            var cache = new Mock<ILinkCache<ISkyrimMod, ISkyrimModGetter>>(MockBehavior.Strict);
            IRaceGetter? race = new Race(FormKey.Factory("ABCDEF:Requiem.esp"), SkyrimRelease.SkyrimSE)
