...
* Tempered items no longer use custom labels and are now simply marked as "Tempered". This change reflects Requiem's tempering formula, which made the previous labels unclear and often confusing.
