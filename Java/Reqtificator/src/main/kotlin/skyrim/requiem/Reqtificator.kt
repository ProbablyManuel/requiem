...
class Reqtificator(private val language: Locale) : SUM {
    ...
    override fun onStart() {
        ...
        logger.info("Hg revision: ${patcherMetadata.commitChecksum}")
        logger.info("Hg branch: ${patcherMetadata.mercurialBranch}")
        logger.info("Hg tags: ${patcherMetadata.mercurialBookmarks}")
