...
As announced in [Sovngarde Awaits]({% post_url 2022-05-05-Developer-Diary-12 %}), Ogerboss has made the decision to end his engagement in Requiem. This is the last release in which he took part before his journey to Sovngarde. It addresses more common installation problems, improves compatibility with some mods, and fixes two important bugs.
...
Alongside this release I’m sharing my vision for Requiem’s future in [Roadmap to Requiem 6.0.0]({% post_url 2022-05-08-Developer-Diary-13 %}).
